...
;; Modified a little: the response of constraint and probe objects
;; to 'I-have-a-value and 'I-lost-my-value messages
;; is now to do the operation directly, instead of returning a function
;; (since these operations are parameterless)
