...
(define prog "~cs61a/lib/proj4/load.scm")
...
; doesn't muck up our logs. Pipe errors to loading-errors so students
; may examine errors.
(define job (run-process "stk" "-no-tk" "-file" prog :error "loading-errors" :output "/dev/null" :wait #f))
